...
- `Customer#family_name` # done
  ...
  - should be able to change after the customer is created ^
- `Customer#full_name` # done seems good. 
  - returns the full name of the customer, with the given name and the family name concatenated, Western style. # they are two separate arguments at first
- `Customer.all` #done
...
- `Review#initialize` #done
  - Reviews should be initialized with a customer, restaurant, and a rating (a number) # works
- `Review#rating` # done
...
- `Customer#restaurants` AHHH
  - Returns a **unique** array of all restaurants a customer has reviewed
- `Customer#add_review(restaurant, rating)` dnoe
...
- `Restaurant#average_star_rating` ?? done ish
